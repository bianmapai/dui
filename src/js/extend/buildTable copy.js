        ...
        that.events = {
            ...
            valueClick:function(e){
                ...
                if(type=='enum'){
                    ...
                    template = $(['<ul class="dui-query__value-enum-popper dui-popper dui-dropdown-menu" style="display: none;">'+
                        function(){
                            var res = '';
                            $.each(options,function(key,option){
                                res += '<li class="dui-dropdown-menu__item" data-value="'+key+'"'+(value==key ? ' is-select':'')+'>'+option+'</li>'                                        
                            })
                            return res;
                        }()
                    +'</ul>'].join(''));
                    ...
                    pop.on('click',Selector.searchPopperItem,function(){
                    ...
                    formDom.html('').append(template).find('input').focus();
                }
                if(type=='timestamp'){
